...
import com.app.SIAKAD.databinding.FragmentDashboardMahasiswaBinding
import com.app.SIAKAD.ui.adapter.MenuAkademikCardAdapter
import com.app.SIAKAD.ui.adapter.MenuAkademikGridAdapter
import com.app.SIAKAD.ui.adapter.MenuAkademikListAdapter
import com.app.SIAKAD.utils.MenuLayoutMode

class DashboardMahasiswaFragment : Fragment(R.layout.fragment_dashboard_mahasiswa) {

    private var _binding: FragmentDashboardMahasiswaBinding? = null
    ...
    companion object {
        private const val ARG_ID = "arg_mahasiswa_id"

        fun newInstance(mahasiswaId: Int): DashboardMahasiswaFragment {
            return DashboardMahasiswaFragment().apply {
                arguments = Bundle().apply { putInt(ARG_ID, mahasiswaId) }
            }
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentDashboardMahasiswaBinding.bind(view)
